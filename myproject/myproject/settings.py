...
SECRET_KEY = 'django-insecure-0t$uu-6zc!4-id0-l)m-pf7cu*w(z%yvm$^loa_wi9rg!*-1^o'
...
MIDDLEWARE = [
    ...
    # 'myproject.main.middleware.AuthMiddleware',
]
...
LOGIN_URL = 'login'  # Укажите URL для страницы входа
LOGIN_REDIRECT_URL = '/'